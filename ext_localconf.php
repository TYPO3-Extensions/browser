...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['processDatamapClass'][] = 'EXT::browser/lib/class.tx_browser_processDatamapClass.php:&processDatamap_beforeStart';
  // SC_OPTIONS
