...
$( document ).ready( function( )
{
  ...
  $( 'body' ).t3browser({
    messages: {
      ...
      hlpForumPrmpt:              "Wenn Du den Fehler nicht beheben kannst, kannst Du Hilfe im <a href=\"http://typo3-browser.forum.de/\">TYPO3-Browser-Forum auf typo3-browser.forum.de</a> bekommen.",
