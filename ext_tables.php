...
if (!defined ('TYPO3_MODE'))  die ('Access denied.');
  ...
  switch(true) {
    case($llStatic == 'de'):
      // German
      // Plugin 1
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/Foundation/Framework/',  'Browser [-] Foundation Framework');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/',                       'Browser [1]');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/downgrade/4.5.4/',       'Browser [1] v4.5');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/downgrade/4.5.4/map/',   'Browser [1+] +v4.5 oxMap <= 1.2');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/downgrade/3.9.0/',       'Browser [1] v3.9');
        // Plugin 5
      t3lib_extMgm::addStaticFile($_EXTKEY,'pi5/static/',                   'Browser [2+] +Kalender');
        // Plugin 1
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/samples/tt_content/',    'Browser [3+] +Out of the Box');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/samples/tt_news/',       'Browser [3+] +Beispiel fuer tt_news');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/samples/dam/',           'Browser [3+] +Beispiel fuer DAM');
    ...
    default:
      ...
      t3lib_extMgm::addStaticFile($_EXTKEY,'pi5/static/',                   'Browser [2+] +Calendar');
        // Plugin 1
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/samples/tt_content/',    'Browser [3+] +out of the box');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/samples/tt_news/',       'Browser [3+] +Sample for tt_news');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/samples/dam/',           'Browser [3+] +Sample for DAM');
      t3lib_extMgm::addStaticFile($_EXTKEY,'static/Foundation/Templating/', 'Browser [5+] +Foundation Templates');
        // Plugin 4
