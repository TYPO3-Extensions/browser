...
/**
 * The class tx_browser_pi1_viewlist_3x bundles methods for displaying the list view and the singe view for the extension browser
 *
 ...
 *
 *
 *   67: class tx_browser_pi1_viewlist_3x
 ...
 *
 */
class tx_browser_pi1_viewlist_3x
{
...
//    }
    ...
    if ( !( $conf_view[ 'random' ] == 1 ) )
    {
      ...
      $rows = $this->pObj->rows;
      // Prompt the expired time to devlog
      $this->pObj->timeTracking_log( 1, 'after $this->pObj->objMultisort->main( )' );
    }
    // Ordering the rows
    /////////////////////////////////////////////////////////////////
    //
...
//  // #33892, 120214, dwildt+
    ...
    if ( $this->pObj->bool_accessByIP )
    {
      if ( ( $tt_end - $tt_start ) > 1000 )
      {
        ...
        $header = 'FATAL ERROR!';
        $text = 'This query needs more than one second: ' . $query;
...
if ( defined( 'TYPO3_MODE' ) && $TYPO3_CONF_VARS[ TYPO3_MODE ][ 'XCLASS' ][ 'ext/browser/pi1/class.tx_browser_pi1_viewlist_3x.php' ] )
{
//  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/browser/pi1/class.tx_browser_pi1_viewlist_3x.php']);
}
?>