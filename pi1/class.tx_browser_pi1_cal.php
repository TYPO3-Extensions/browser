 ...
 *
 *
 *   60: class tx_browser_pi1_cal
 *   82:     function __construct($pObj)
 *
 *              SECTION: Filter
 *  117:     function area_init()
 *  191:     function area_interval($arr_ts, $arr_values, $tableField)
 *  220:     function area_strings($arr_ts, $arr_values, $tableField)
 *
 *              SECTION: Area Helper
 *  294:     function area_get_urlPeriod($arr_ts, $tableField, $tsKey)
 *  365:     function area_get_tsKey_from_urlPeriod($tableField, $str_urlPeriod)
 *  422:     function area_set_hits($arr_ts, $arr_values, $tableField)
 *  561:     function area_set_tsPeriod($arr_ts, $tableField)
 *
 * TOTAL FUNCTIONS: 8
