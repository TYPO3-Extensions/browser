...
/**
 * The class tx_browser_pi1_wrapper4x bundles wrapper methods for the extension browser
 *
 ...
 *
 *
 *   60: class tx_browser_pi1_wrapper4x
 *   77:     function __construct($parentObj)
 *   94:     public function constant_markers()
 *  263:     public function wrapAndLinkValue($tableField, $value, $recordId = 0)
 *  813:     private function wrapAndLinkValue_Children($xsv_values, $lConfCObj, $ext)
 *  899:     public function wrapImage($tsImage)
 * 1087:     public function wrapInBaseIdClass($content)
 * 1116:     public function wrapDocument($documents)
 * 1176:     public function wrapYYYYMMDD($specialDate)
 * 1223:     public function general_stdWrap($str, $arr_tsConf)
 * 1249:     public function tableSummary($view)
 * 1297:     public function tableCaption($view)
 * 1338:     public function wrapTableFields($wrapThisString, $elements)
 *
 * TOTAL FUNCTIONS: 12
 * (This index is automatically created/updated by the extension "extdeveval")
 *
 */
class tx_browser_pi1_wrapper4x
{
