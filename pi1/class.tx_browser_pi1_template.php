...
//      $arr_orderBox_value_label[$field.':'.$b_asc] = $fieldLL;
      ...
      foreach((array) $arr_values as $value => $label)
      {
        ...
        $conf_item  = $this->pObj->objFltr3x->get_wrappedItemClass($arr_ts, $conf_item, $str_order);
        // Wrap the item style
        $conf_item  = $this->pObj->objFltr3x->get_wrappedItemStyle($arr_ts, $conf_item, $str_order);
        // Wrap the item uid
...
if( $this->pObj->boolFirstRow )
{
  $this->pObj->dev_var_dump( $this->_elementsTransformed, $this->pObj->cObj->data );    
}
