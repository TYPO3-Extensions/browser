  ...
  frameworks {
    foundation {
      framework {
        ...
        page.includeCSS.foundation  = EXT:browser/res/foundation-5.3.0/css/foundation.min.css
        ...
        page.includeCSS.normalize   = EXT:browser/res/foundation-5.3.0/css/normalize.css
        ...
        page.includeJSFooter.foundation = EXT:browser/res/foundation-5.3.0/js/foundation.min.js
        ...
        page.includeJSFooter.jquery     = EXT:browser/res/foundation-5.3.0/js/vendor/jquery.js
        # cat=browser foundation - framework - Javascript/250/103; type=string;        label= modernizr:Path to the modernizr.js file.
        page.includeJS.modernizr        = EXT:browser/res/foundation-5.3.0/js/vendor/modernizr.js
