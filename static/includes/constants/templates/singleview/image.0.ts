plugin.tx_browser_pi1 {
  ...
  # cat=Browser - Templates - Single - Image 0*//110;         type=string;     label= Height:Field with the image height. I.e: tx_org_service.imageheight
  templates.singleview.image.0.height     =
  # cat=Browser - Templates - Single - Image 0*//111;         type=string;     label= Width:Field with the image width. I.e: tx_org_service.imagewidth
  templates.singleview.image.0.width      =
  # cat=Browser - Templates - Single - Image 0*//112;         type=string;     label= SEO field:Field for Search Engine Optimisation (SEO). The field for alttext and the titletext property. I.e. tx_org_service.imageseo
  templates.singleview.image.0.seo        =
  # cat=Browser - Templates - Single - Image 0*//113;         type=string;     label= Caption:Field for the image caption. I.e. tx_org_service.imagecaption
  templates.singleview.image.0.caption    =
  # cat=Browser - Templates - Single - Image 0*//113;         type=options[data,default,picture,srcset];     label= Render layout:data: renders an image tag containing data-keys for the different resolutions. default: renders a normal non-responsive image as a <img> tag. picture: renders a picture tag containing source tags for each resolutions and an <img> tag for the default image. srcset: renders an image tag pointing to a set of images for the different resolutions.
