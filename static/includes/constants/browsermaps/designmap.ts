plugin.tx_browser_pi1 {
  ...
  map.design.css      = /typo3conf/ext/browser/res/js/map/lib/OpenLayers_2.12/theme/default/style.css
  ...
  map.design.imgPath  = /typo3conf/ext/browser/res/js/map/lib/OpenLayers_2.12/img/
