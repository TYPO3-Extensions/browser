                  ...
                  10 {
                    ...
                    10 {
                      ...
                      value (
                        ...
                        <!--<script src="typo3conf/ext/browser/res/js/map/lib/OpenLayers_2.12/ol-te7.js"></script>-->
                        <script src="typo3conf/ext/browser/res/js/map/lib/OpenLayers_2.13/OpenLayers.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/lib/OpenStreetMap/OpenStreetMap_1.3.10.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.Utils.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.Error.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.CDmap.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.Filter.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.Marker.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.mobile.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.Route.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.Tooltip.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.js"></script>
                  ...
                  20 {
                    ...
                    10 {
                      ...
                      value (
                        ...
                        <script src="typo3conf/ext/browser/res/js/map/oxMap.Render_1.3.07.js"></script>
                        <script>new oxMapRender(configuration)</script>
                    ...
                    20 {
                      ...
                      value (
                        ...
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.Route.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.Tooltip.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.OSM.js"></script>
                        <script src="typo3conf/ext/browser/res/js/map/api/1.3.10/oxMap.js"></script>
                        <script>new oxMapRender(configuration)</script>
