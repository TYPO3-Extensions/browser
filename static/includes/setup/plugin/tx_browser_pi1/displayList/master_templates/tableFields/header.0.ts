      ...
      tableFields {
        ...
        header {
          ...
          0 {
            ...
            default = TEXT
            default {
              field = {$plugin.tx_browser_pi1.templates.listview.header.0.list} // {$plugin.tx_browser_pi1.templates.listview.header.0.single}
              wrap  = <h2>|</h2>
              stdWrap {
                stripHtml         = 1
                htmlSpecialChars  = 1
                crop              = {$plugin.tx_browser_pi1.templates.listview.header.0.crop} | ... | 1
              }
