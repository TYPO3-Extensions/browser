        ...
        image {
          ...
          1 {
            ...
            10 {
              if {
                isTrue {
                  field = {$plugin.tx_browser_pi1.templates.listview.image.1.file}
                  listNum = {$plugin.tx_browser_pi1.templates.listview.image.1.listNum}
                }
              }
              key {
              ...
              default {
                file {
                  import = {$plugin.tx_browser_pi1.templates.listview.image.1.path}
                  import {
                    field   = {$plugin.tx_browser_pi1.templates.listview.image.1.file}
                    listNum = {$plugin.tx_browser_pi1.templates.listview.image.1.listNum}
                  }
                  height = {$plugin.tx_browser_pi1.templates.listview.image.1.height}
                  width = {$plugin.tx_browser_pi1.templates.listview.image.1.width}
                }
                altText = TEXT
                altText {
                  field = {$plugin.tx_browser_pi1.templates.listview.image.1.seo} // {$plugin.tx_browser_pi1.templates.listview.header.1.list} // {$plugin.tx_browser_pi1.templates.listview.header.1.single}
                  stdWrap {
                    stripHtml = 1
                    htmlSpecialChars = 1
                  }
                ...
                layoutKey = {$plugin.tx_browser_pi1.templates.listview.image.1.layoutkey}
                layout {
                  data {
            ...
            20 {
              ...
              default {
                file = {$plugin.tx_browser_pi1.templates.listview.image.1.default}
              }
              notype {
                file = {$plugin.tx_browser_pi1.templates.listview.image.1.default}
              }
