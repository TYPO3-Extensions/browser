  ...
  frameworks {
    foundation {
      framework {
        ...
        page.includeCSS.foundation  = EXT:browser/Resources/Public/JavaScript/foundation-5.4.5/css/foundation.min.css
        ...
        page.includeCSS.normalize   = EXT:browser/Resources/Public/JavaScript/foundation-5.4.5/css/normalize.css
        ...
        page.includeJSFooter.foundation = EXT:browser/Resources/Public/JavaScript/foundation-5.4.5/js/foundation.min.js
