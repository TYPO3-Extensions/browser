    ...
    extensions {
      ...
      browser {
        foundationMain01 {
          ...
          image     = EXT:browser/Resources/Public/Images/BackendLayouts/Foundation/f-main_01.gif
          csvViews  = all
        }
        foundationMain02 {
          ...
          image     = EXT:browser/Resources/Public/Images/BackendLayouts/Foundation/f-main_02.gif
          csvViews  = all
        }
        foundationMain03 {
          name      = Foundation 3: one column
          file      = EXT:browser/Resources/Private/Templates/HTML/Foundation/main_03.html
          image     = EXT:browser/Resources/Public/Images/BackendLayouts/Foundation/f-main_03.gif
          csvViews  = all
        }
        foundationMain04 {
          ...
          image     = EXT:browser/Resources/Public/Images/BackendLayouts/Foundation/f-main_04.gif
          csvViews  = all
        }
        foundationMain05 {
          ...
          image     = EXT:browser/Resources/Public/Images/BackendLayouts/Foundation/f-main_05.gif
          csvViews  = all
        }
      }
    }
