        ...
        image {
          ...
          1 {
            ...
            default {
                  ...
                  stdWrap {
                    ...
                    cObject {
                      ...
                      10 {
                        ...
                        10 = TEXT
                        10 {
                          value = {$plugin.tx_browser_pi1.templates.listview.image.1.path}
                        }
                        20 = TEXT
                        20 {
                          field   = {$plugin.tx_browser_pi1.templates.listview.image.1.file}
                      ...
                      20 {
                        ...
                        value = {$plugin.tx_browser_pi1.templates.listview.image.1.default}
                      }
                    }
                  }
                }
              ...
              altText = TEXT
              altText {
                field = {$plugin.tx_browser_pi1.templates.listview.image.1.seo}
                stdWrap {
                  stripHtml = 1
                  htmlSpecialChars = 1
                }
