        ...
        image {
          ...
          4 {
            ...
            default {
                  ...
                  stdWrap {
                    ...
                    cObject {
                      ...
                      10 {
                        if {
                          isTrue {
                            field = {$plugin.tx_browser_pi1.templates.listview.image.4.file}
                            listNum = {$plugin.tx_browser_pi1.templates.listview.image.4.listNum}
                          }
                        }
                        10 = TEXT
                        10 {
                          value = {$plugin.tx_browser_pi1.templates.listview.image.4.path}
                        }
                        20 = TEXT
                        20 {
                          field   = {$plugin.tx_browser_pi1.templates.listview.image.4.file}
                      ...
                      20 {
                        ...
                        value = {$plugin.tx_browser_pi1.templates.listview.image.4.default}
                      }
                    }
                  }
                }
                height = {$plugin.tx_browser_pi1.templates.listview.image.4.height}
                width = {$plugin.tx_browser_pi1.templates.listview.image.4.width}
              }
              altText = TEXT
              altText {
                field = {$plugin.tx_browser_pi1.templates.listview.image.4.seo}
                stdWrap {
                  stripHtml = 1
                  htmlSpecialChars = 1
                }
              ...
              layoutKey = {$plugin.tx_browser_pi1.templates.listview.image.4.layoutKey}
              layout {
                data {
