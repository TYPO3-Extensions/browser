        ...
        image {
          ...
          0 {
            ...
            default {
                  ...
                  stdWrap {
                    ...
                    cObject {
                      ...
                      10 {
                        ...
                        10 = TEXT
                        10 {
                          value = {$plugin.tx_browser_pi1.templates.listview.image.0.path}
                        }
                        20 = TEXT
                        20 {
                          field   = {$plugin.tx_browser_pi1.templates.listview.image.0.file}
                      ...
                      20 {
                        ...
                        value = {$plugin.tx_browser_pi1.templates.listview.image.0.default}
                      }
                    }
                  }
                }
              ...
              altText = TEXT
              altText {
                field = {$plugin.tx_browser_pi1.templates.listview.image.0.seo}
                stdWrap {
                  stripHtml = 1
                  htmlSpecialChars = 1
                }
