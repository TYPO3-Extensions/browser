            ...
            default {
              ...
              parameter{
                ...
                cObject {
                  ...
                  40 = TEXT
                  40 {
                    field = {$plugin.tx_browser_pi1.templates.listview.header.5.title}
                    stdWrap {
                      stripHtml         = 1
                      htmlSpecialChars  = 1
                      crop              = {$plugin.tx_browser_pi1.templates.listview.header.5.title.crop}
                    }
                    noTrimWrap  = | "|"|
                  }
                }
              ...
              useCacheHash = 1
              returnLast = {$plugin.tx_browser_pi1.templates.listview.url.5.returnLast}
            }
