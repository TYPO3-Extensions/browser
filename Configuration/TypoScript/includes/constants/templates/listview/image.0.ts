plugin.tx_browser_pi1 {
  ...
  templates.listview.image.0.file       = EXT:browser/Resources/Public/Images/Icons/alternate_image_400x300.gif
  ...
  # cat=Browser - Templates - List - Image 0*//130;         type=string;     label= Path*:(Obligate!) Path to the images (with ending backslash!). I.e: uploads/tx_org/
  templates.listview.image.0.path       =
  # cat=Browser - Templates - List - Image 0*//130;         type=string;     label= Default image:Full qualified path to the default image. I.e: EXT:browser/Resources/Public/Images/Icons/browser_default_300x200.gif
  templates.listview.image.0.default    = EXT:browser/Resources/Public/Images/Icons/browser_default_300x200.gif
