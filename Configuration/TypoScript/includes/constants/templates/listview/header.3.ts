plugin.tx_browser_pi1 {
  ...
  # cat=Browser - Templates - List - Header 3*//104;        type=string;    label= Title:Field with the title property of the a tag. I.e: tx_org_service.teaser_short // tx_org_service.bodytext
  templates.listview.header.3.title  =
  # cat=Browser - Templates - List - Header 3*//105;        type=string;    label= Crop title:Crop the title after x chars. Leave it empty, if you don't want any cropping. I.e: 80|...|1
  templates.listview.header.3.title.crop  = 80|...|1
