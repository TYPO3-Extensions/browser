plugin.tx_browser_pi1 {
  ...
  # cat=Browser - Templates - Single - vCard.0//302;         type=string;     label= GEO lon:Field for the GEO longitude property. Example: tx_org_headquarters.mail_lon. Details at http://tools.ietf.org/html/rfc6350#section-6.5.2
  templates.singleview.vCard.0.field.geo.lon  =
  # cat=Browser - Templates - Single - vCard.0//500;         type=string;     label= ORG:Field for the ORG (organisation name) property. Example: tx_org_headquarters.title. Details at http://tools.ietf.org/html/rfc6350#section-6.6.4
  templates.singleview.vCard.0.field.org =
  # cat=Browser - Templates - Single - vCard.0//501;         type=string;     label= TITLE:Field for the TITLE (position or job of the object the vCard) property. Example: tx_org_staff.position. Details at http://tools.ietf.org/html/rfc6350#section-6.6.1
  templates.singleview.vCard.0.field.title =
  # cat=Browser - Templates - Single - vCard.0//601;         type=string;     label= EMAIL work:Field for the EMAIL work property. Example: tx_org_staff.contact_email. Details at http://tools.ietf.org/html/rfc6350#section-6.4.2
  templates.singleview.vCard.0.field.email.work  =
  # cat=Browser - Templates - Single - vCard.0//611;         type=string;     label= IMPP skype:Field for the IMPP skype property. Example: tx_org_staff.contact_skype. Details at http://tools.ietf.org/html/rfc6350#section-6.4.3
  templates.singleview.vCard.0.field.impp.skype  =
  # cat=Browser - Templates - Single - vCard.0//621;         type=string;     label= TEL work voice:Field for the TEL work voice property. Example: tx_org_staff.contact_phone. Details at http://tools.ietf.org/html/rfc6350#section-6.4.1
