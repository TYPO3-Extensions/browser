plugin.tx_browser_pi1 {
  ...
  # cat=Browser - Templates - Single - Image 1*//110;         type=string;     label= Height field:Field with the image height. I.e: tx_org_service.imageheight
  templates.singleview.image.1.height     =
  # cat=Browser - Templates - Single - Image 1*//111;         type=string;     label= Height default:Default height of the image in pixel. I.e: width = 120c and height = 80c crops 120x80px from the center of the scaled image. Width = 100c-100 and height = 100c crops 100x100px from landscape-images at the left and portrait- images centered. Width = 100c+30 height = 100c-25 crops 100x100px from landscape-images a bit right of the center and portrait-images a bit higher than centered.
  templates.singleview.image.1.heightDefault =
  # cat=Browser - Templates - Single - Image 1*//112;         type=string;     label= Width field:Field with the image width. I.e: tx_org_service.imagewidth
  templates.singleview.image.1.width      =
  # cat=Browser - Templates - Single - Image 1*//113;         type=string;     label= Width default:Default width of the image in pixel. See the samples at property height above.
  templates.singleview.image.1.widthDefault = 600
  # cat=Browser - Templates - Single - Image 1*//114;         type=string;     label= SEO field:Field for Search Engine Optimisation (SEO). The field for alttext and the titletext property. I.e. tx_org_service.imageseo
  templates.singleview.image.1.seo        =
  # cat=Browser - Templates - Single - Image 1*//115;         type=string;     label= Caption:Field for the image caption. I.e. tx_org_service.imagecaption
  templates.singleview.image.1.caption    =
  # cat=Browser - Templates - Single - Image 1*//116;         type=string;     label= Image orient:Field for the image orient. I.e. tx_org_service.imageorient
