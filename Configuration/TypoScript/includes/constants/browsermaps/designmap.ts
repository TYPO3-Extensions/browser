plugin.tx_browser_pi1 {
  ...
  # cat=BrowserMaps - Design Map//100;             type=int+;      label= Map height: Height of the map in the list view (in pixel)
  map.design.height = 400
  # cat=BrowserMaps - Design Map//101;             type=int+;      label= Map width: Width of the map in the list view (in pixel)
  ...
  map.design.css      = /typo3conf/ext/browser/Resources/Public/JavaScript/Map/lib/OpenLayers_2.12/theme/default/style.css
  ...
  map.design.imgPath  = /typo3conf/ext/browser/Resources/Public/JavaScript/Map/lib/OpenLayers_2.12/img/
