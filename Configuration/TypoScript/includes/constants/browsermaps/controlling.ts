plugin.tx_browser_pi1 {
  ...
  # cat=BrowserMaps - Controlling//401;             type=options[disabled,Map,Map +Routes];   label= Enable the map:[DEPRECATED] for oxMap only! Map: Map with marker only. Map +Routes: Map with routes and marker (oxMap only!)
