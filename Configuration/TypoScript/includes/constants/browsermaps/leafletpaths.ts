plugin.tx_browser_pi1 {
  ...
  map.leafletfiles.css    = EXT:browser/Resources/Public/JavaScript/Map/Leaflet/0.7.7/leaflet.css
  # cat=BrowserMaps - leaflet files//102;           type=string;    label= JavaScript: Path to the javascript library
  map.leafletfiles.js     = EXT:browser/Resources/Public/JavaScript/Map/Leaflet/0.7.7/leaflet.js
