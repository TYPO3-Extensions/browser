plugin.tx_browser_pi1 {
  ...
  # cat=Browser - Navigation//101;            type=string;  label= showUid: Alias for the parameter showUid. WARNING: Set this property for main plugins only, don't set it for plugins in the marginal column. in Alias simplifies the configuration of realUrl. I.e: staffUid.
