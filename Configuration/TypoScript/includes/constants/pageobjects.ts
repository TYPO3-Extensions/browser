plugin.tx_browser_pi1 {
  ...
  # cat=Browser - Page Objects//201;       type=string;    label= vCard additionalHeaders: additionalHeaders for the vCard page object.
  ...
  # cat=Browser - Page Objects//400;       type=int+;    label= Page object for map category markers: Type number (typenum) of the map page object. Default: 32654
  typeNum.mapPageObj = 32654
  # cat=Browser - Page Objects//401;       type=string;    label= vCard additionalHeaders: additionalHeaders for the vCard page object.
