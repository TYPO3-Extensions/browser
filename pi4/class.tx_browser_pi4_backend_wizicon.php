 ...
 *
 */
class tx_browser_pi4_backend_wizicon
{
	function proc($wizardItems)
  {
    ...
    $wizardItems['plugins_tx_browser_pi4'] =
			array
			(
      	'icon'				=> t3lib_extMgm::extRelPath('browser').'pi4/browser_wizard2.gif',
        'title'   		=> $LANG->getLLL('wizard.list_type_pi4', $LL),
        'description'	=> $LANG->getLLL('wizard.list_type_pi4.desc', $LL),
        'params'			=> '&defVals[tt_content][CType]=list&defVals[tt_content][list_type]=browser_pi4'
      );
    return $wizardItems;
  }
