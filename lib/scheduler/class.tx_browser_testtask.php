 ...
 */
class tx_browser_TestTask extends tx_scheduler_Task {
 ...
 */
    public function execute() {
        ...
        if (!empty($this->browser_browserAdminEmail)) {
            ...
            t3lib_div::devLog('[tx_browser_TestTask]: Test email sent to "' . $this->browser_browserAdminEmail . '"', 'browser', 0);
            ...
            t3lib_div::devLog('[tx_browser_TestTask]: No email address given', 'browser', 2);
        }
 ...
 */
    public function getAdditionalInformation() {
        return $GLOBALS['LANG']->sL('LLL:EXT:browser/lib/scheduler/locallang.xml:label.browserAdminEmail') . ': ' . $this->browser_browserAdminEmail;
    }
}

if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/browser/lib/scheduler/class.tx_browser_testtask.php'])) {
    include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/browser/lib/scheduler/class.tx_browser_testtask.php']);
}
