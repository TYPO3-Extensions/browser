...
class tx_browser_userfunc extends tslib_pibase
{

    // The extension key.
  public $extKey        = 'browser';
  public $prefixId      = 'tx_browser_userfunc';
    // Path to any file in pi1 for locallang
  public $scriptRelPath = 'lib/class.tx_browser_userfunc.php';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/browser/lib/class.tx_browser_userfunc.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/browser/lib/class.tx_browser_userfunc.php']);
}
